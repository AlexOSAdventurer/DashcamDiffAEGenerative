...
config_file = os.environ['CLS_CONFIG']
config_data = yaml.safe_load(open(config_file))
config_choice = os.path.dirname(config_file)
base_dir = os.path.dirname(__file__)
dataset_path_train_semantic = os.path.join(base_dir, config_data['data']['train'])
dataset_path_val_semantic = os.path.join(base_dir, config_data['data']['val'])
dataset_path_train_labels = os.path.join(base_dir, config_data['data']['train_labels'])
dataset_path_val_labels = os.path.join(base_dir, config_data['data']['val_labels'])
...
if __name__ == '__main__':
    ...
    train_dataset = dataset_type(dataset_path_train_semantic, dataset_path_train_labels, dataset_train_dataset_length)
    val_dataset = dataset_type(dataset_path_val_semantic, dataset_path_val_labels)
