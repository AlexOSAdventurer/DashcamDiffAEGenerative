...
latent_data = numpy.load("./video_train_256x256_latent_2.npy", mmap_mode='r')
...
original_img = numpy.clip(((original_data[242][79:] / 255.0) * 2) - 1, -1.0, 1.0).copy()
...
latent_moment = torch.from_numpy(latent_data[242][79:].copy()).type(torch.FloatTensor)
